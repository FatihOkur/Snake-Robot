        ...
        while step_index < total_steps:
            ...
            if incoming_bytes:
                ...
                if "REQ" in incoming_str:
                    ...
                    # ============================================================
                    # 🚨 TEST HAZARD INJECTION — simulates 100% track slip
                    # The robot's motor spins but it doesn't move (e.g. deep mud).
                    # On the configured step, we zero out m2_pulses so the
                    # StateEstimator sees 0 displacement, while the JSON still
